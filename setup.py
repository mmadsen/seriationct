...
setup(name="seriationct",
      ...
      scripts = [
          ...
          'analytics/builders/seriationct-simulation-sample-export-builder.py',
          'analytics/processors/seriationct-sample-exported-datafile.py',
          ...
          'analytics/processors/seriationct-sample-assemblages-for-seriation.py',
